...
public class ScrollingScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (!gm.car.GetComponent<Car>().IsCrash())
        {
            ...
            // Movement
            Vector3 movement = new Vector3(speed.x * (carSpeedX / 13) * direction.x, speed.y * (carSpeedY / 13) * direction.y, 0);
            ...
            if (isLooping)
            {
                ...
                if (firstChild != null)
                {
                    ...
                    if (firstChild.transform.position.x < Camera.main.transform.position.x - 45f)
                    {
